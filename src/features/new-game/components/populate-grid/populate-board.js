...
function createCellIdObject(cell) {
  const cellDataset = cell.dataset;
  const cellIdObject = { letterCoordinate: cellDataset.letterCoordinate, numberCoordinate: cellDataset.numberCoordinate };

  return cellIdObject;
}

function getFreeCells(playerReference) {
